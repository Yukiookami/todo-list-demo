<!--
 * @Author: zxy
 * @Date: 2022-04-26 17:16:36
 * @LastEditTime: 2022-04-27 17:09:15
 * @FilePath: /todo-list-demo/src/components/todoListItem.vue
-->
<template>
...
const emit = defineEmits(['changeCheck', 'delItem'])
